...
void CubeShape::Show(HDC hdc, int defPen)
{
	...
	__x2 = xs2;
	__y2 = ys2;
	RectangleShape::Set(__x1 - cubeMerge, __y1 - cubeMerge,
		__x1 + cubeMerge, __y1 + cubeMerge);
	RectangleShape::Show(hdc, defPen);
	RectangleShape::Set(__x2 - cubeMerge, __y2 - cubeMerge,
		__x2 + cubeMerge, __y2 + cubeMerge);
	RectangleShape::Show(hdc, defPen);
	LineShape::Set(__x1 - cubeMerge, __y1 - cubeMerge,
		__x2 - cubeMerge, __y2 - cubeMerge);
	LineShape::Show(hdc, defPen);
	LineShape::Set(__x1 - cubeMerge, __y1 + cubeMerge,
		__x2 - cubeMerge, __y2 + cubeMerge);
